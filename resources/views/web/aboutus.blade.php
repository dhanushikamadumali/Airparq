                ...
                <div class="col-12 col-xl-6 order-1 order-xl-0">
                    ...
                    <div class="image-info image-info-vertical me-xl-5 aboutus">
                        <div class="image-center rounded">
                             <img src="{{asset('account/img/img24.jpg')}}" style="height:350px;width:450px" alt="">
                        </div>
                    </div>
                    <!-- /Image -->
                </div>
            ...
            <div class="container">
                <div class="row g-0">
                    <div class="col-12 col-xl-6 order-1 order-xl-1">
                        ...
                        <div class="image-info image-info-vertical me-xl-5 aboutus">
                            <div class="image-center rounded">
                                 <img src="{{asset('account/img/airparq-certificate.png')}}" style="height:350px;width:450px" alt="">
                            </div>
                        </div>
                        <!-- /Image -->
                    </div>
